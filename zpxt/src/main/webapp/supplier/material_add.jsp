		...
		$("#submitbutton").click(function() {
			 ...
			 for(var i = 0;i<params.length;i++){
			  ...
			  $.ajax({ 
	            ...
	            url: basePath+"/MaterialController/save.do", 
...
<form id="submitForm" name="submitForm" method="post">
	<div id="container">
		<div id="nav_links">
			当前位置：面料管理&nbsp;>&nbsp;<span style="color: #1A5CC6;">面料新增</span>
			<div id="page_close">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="material" name="material" class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
					<td class="ui_text_rt">颜色${pList}</td>
					<td class="ui_text_lt">
						<select name="colorID" id="colorID" class="ui_select01">
                             <c:forEach items="${plist}" var="ps"  varStatus="i">
                                   <option value="${ps.id}">${ps.colorName}</option>
                             </c:forEach>
					...
					<td class="ui_text_lt">
					  <input type="text" id="component" name="component" class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
				</tr>
				<tr>
				<td class="ui_text_rt">克重</td>
					<td class="ui_text_lt">
						<input type="text" id="gramWeight" name="gramWeight"  class="ui_input_txt02"/>
					</td>
					<td class="ui_text_rt">幅宽</td>
					<td class="ui_text_lt">
						<input id="width" name="width" type="text" class="ui_input_txt02"/>
					</td>
					<td class="ui_text_rt">有效幅宽</td>
					<td class="ui_text_lt">
						<input id="validWidth" name="validWidth" type="text" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					...
					<td class="ui_text_lt">
						<select name="supplierID" id="supplierID" class="ui_select01">
                             <c:forEach items="${dlist}" var="ps"  varStatus="i">
                                   <option value="${ps.id}">${ps.supplierName}</option>
                             </c:forEach>
                        </select>
					</td>
				</tr>
