		...
		$("#submitbutton").click(function() {
			 ...
			 for(var i = 0;i<params.length;i++){
			  ...
			  $.ajax({ 
	            ...
	            url: basePath+"/CustomerController/save.do", 
...
<form id="submitForm" name="submitForm" method="post">
	<div id="container">
		<div id="nav_links">
			当前位置：客户管理&nbsp;>&nbsp;<span style="color: #1A5CC6;">客户新增</span>
			<div id="page_close">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="custName" name="custName" class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
					...
					<td class="ui_text_lt">
						<input type="text" id="contactPerson" name="contactPerson" class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
				</tr>
				<tr>
				<td class="ui_text_rt">职位</td>
					...
					<td class="ui_text_lt">
						<input id="phone" name="phone" type="text" class="ui_input_txt02"/>
					</td>
					<td class="ui_text_rt">固话</td>
					<td class="ui_text_lt">
						<input id="d11b" name="tel" type="tel" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
				    <td class="ui_text_rt">传真</td>
						...
						<td class="ui_text_lt">
							<input id="payType" name="payType" type="text" class="ui_input_txt02"/>
						</td>
						<td class="ui_text_rt">地址</td>
						<td class="ui_text_lt">
							<input id="address" name="address" type="text" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
				    <td class="ui_text_rt">状态</td>
						...
						<td class="ui_text_lt">
							<input id="remark" name="remark" type="text" class="ui_input_txt02"/>
						</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
