...
<script type="text/javascript" src="<%=basePath %>/js/store/storeHouseList.js"></script>
		...
		<div id="container">
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						<div id="box_center">
						    仓库名称&nbsp;&nbsp;<input type="text" id="storeName" name="storeName" class="ui_input_txt02" value="${storeName}"/>
						</div>
						<div id="box_bottom">
						...
						<tr>
						  ...
						  <c:forEach items="${pagehelper.list}" var="ps"  varStatus="i">
							<tr>
								...
								<td>${ps.statusName}</td>
								<td>${ps.remark}</td>
								<td>${ps.createPerson}</td>
								<td><fmt:formatDate value='${ps.createDate}' pattern='yyyy-MM-dd'/></td>
							</tr>
						  </c:forEach>
					</table>
				</div>
