		...
		$("#submitbutton").click(function() {
			 ...
			 for(var i = 0;i<params.length;i++){
			  ...
			  $.ajax({ 
	            ...
	            url: basePath+"/ColorController/update.do", 
...
<input name="id" value="${color.id}" hidden="hidden"/>
	<div id="container">
		<div id="nav_links">
			当前位置：颜色管理&nbsp;>&nbsp;<span style="color: #1A5CC6;">颜色修改</span>
			<div id="page_close">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="colorScheme" name="colorScheme" value="${color.colorScheme}" class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
					<td class="ui_text_rt">编号</td>
					<td class="ui_text_lt">
						<input type="text" id="code" name="code"  value="${color.code}" class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
				...
				<td class="ui_text_rt">名称</td>
					<td class="ui_text_lt">
						<input type="text" id="colorName" name="colorName"  value="${color.colorName}"   class="ui_input_txt02"/>
					</td>
					<td class="ui_text_rt">创建人</td>
					<td class="ui_text_lt">
						<input id="d11b" name="createPerson" type="text"  value="${color.createPerson}" class="ui_input_txt02"/>
					</td>
				</tr>
