...
<script type="text/javascript" src="<%=basePath %>/js/store/materiaList.js"></script>
		...
		<div id="container">
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						<div id="box_center">
						    面料名称&nbsp;&nbsp;<input type="text" id="material" name="material" class="ui_input_txt02" value="${material.material}"/>
						</div>
						<div id="box_bottom">
						...
						<tr>
						  ...
						  <c:forEach items="${pagehelper.list}" var="ps"  varStatus="i">
							<tr>
								...
								<td>${ps.material}</td>
								<td>${ps.color.colorName}</td>
								<td>${ps.component}</td>
								<td>${ps.gramWeight}</td>
								<td>${ps.width}</td>
								<td>${ps.validWidth}</td>
								<td>${ps.drawHigh}</td>
								<td>${ps.supplier.id}</td>
								<td>${ps.supplier.supplierName}</td>
							</tr>
						  </c:forEach>
					</table>
				</div>
