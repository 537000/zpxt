...
<body style="height: 319px; ">
				...
				<div class="ui_tb">
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						<tr>
						  ...
						  <c:forEach items="${zzxx}" var="ps"  varStatus="i">
							<tr>
								...
								<c:if test="${ps.state==99}">
									...
									<c:if test="${ps.state==3}">
									<td>试用期</td>
								</c:if>
							<td>
							<input name="1"  value="是" type="button"  onclick="upa(${ps.userNo})"></input>
							
							<input name="2" value="否" type="button" onclick="upb(${ps.userNo})"></input>
							</td>
							</tr>
						  </c:forEach>
					</table>
  ...
  <script>
	  ...
	  /*  function apply(){
	   ...
	   function upa(a){
		   location.href = basePath + "/upstate?userNo="+a+"&status=1";
		}
	   function upb(b){
		   location.href = basePath + "/upstate?userNo="+b+"&status=2";
		}
	</script> 
</html>
