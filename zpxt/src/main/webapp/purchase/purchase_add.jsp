...
$(document).ready(function() {
	...
	$("#submitbutton").click(function() {
		 // alert($("#submitForm").serialize());
		 		 var mids="",singles="",produceQuantitys="",sums="",purchaseQuantitys="",shipQuantitys="",signings="";
...
<input type="hidden" id="image" name="image"  class="ui_input_txt02"/>
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<td class="ui_text_rt">公司单号</td>
					<td class="ui_text_lt">
						<input type="text" id="comNo" name="comNo"   class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
					<td class="ui_text_rt" width="80">客户单号</td>
					<td class="ui_text_lt">
						<input type="text" id="cusNo" name="cusNo" class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
	            ...
	            <td class="ui_text_rt">工厂</td>
					<td class="ui_text_lt">
						<input type="text" id="factory" name="factory"  class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
					<td class="ui_text_rt" width="80">物料卡</td>
					<td class="ui_text_lt">
						<input type="text" id="wuliaoka" name="wuliaoka" class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
			  ...
			  <tr>
	            <td class="ui_text_rt">大货纸样板</td>
					<td class="ui_text_lt">
						<input type="text" id="zhiyang" name="zhiyang"  class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
					<td class="ui_text_rt" width="80">生产工艺制单</td>
					<td class="ui_text_lt">
						<input type="text" id="gongyi" name="gongyi" class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
	            ...
	            <td class="ui_text_rt">颜色数量</td>
					<td class="ui_text_lt">
						<input type="text" id="colorNum" name="colorNum"  class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
					<td class="ui_text_rt" width="80">跟单员</td>
					<td class="ui_text_lt">
						<input type="text" id="pman" name="pman" class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
  ...
  <select name="mid">
  	<!-- <option value="">--请选择--</option> -->
                             <c:forEach items="${pist}" var="ps"  varStatus="i">
                                   <option value="${ps.id}" >${ps.material}</option>
                             </c:forEach>
  </select>
 &nbsp;&nbsp; <lable>单间用量</lable>
  <input name="single" type="text" id="single" style="width:100px;vertical-align:middle;" maxlength="40" >
  &nbsp;&nbsp;<lable>生产件数</lable>
  <input name="produceQuantity" type="text" id="produceQuantity" style="width:100px;vertical-align:middle;" maxlength="40" >
  &nbsp;&nbsp;<lable>总量</lable>
  <input name="sum"  type="text" id="sum" style="width:80px;vertical-align:middle;" maxlength="20"  >
  &nbsp;&nbsp; <lable>采购量</lable>
  <input name="purchaseQuantity"  type="text" id="purchaseQuantity" style="width:80px;vertical-align:middle;" maxlength="20"  >
   &nbsp;&nbsp;<lable>发货数量</lable>
  <input name="shipQuantity"  type="text" id="shipQuantity" style="width:80px;vertical-align:middle;" maxlength="20"  >
  &nbsp;&nbsp;<lable>工厂签收人</lable>
  <input name="signing"  type="text" id="signing" style="width:80px;vertical-align:middle;" maxlength="20"  >
