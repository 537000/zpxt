...
<form id="submitForm" name="submitForm" method="post">
	<div id="container">
		...
		<div class="ui_content">
			...
			<input name="id" id="id" value="${orderClaim.id}"  type="hidden"/>
				<tr>
				<td class="ui_text_rt">订单</td>		
				   <td><select name="order" id="order" value="${orderClaim.order}" class="ui_select01">
				   ...
				   <td><select name="customer" id="customer" value="${orderClaim.customer}"  class="ui_select01">
					...
					<td class="ui_text_lt">
						<input id="claimDate" name="claimDate"   value="${orderClaim.claimDate}"  type="text" onClick="WdatePicker()"  class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>	
					<td class="ui_text_rt">索赔理由</td>
					<td class="ui_text_lt">
						<input type="text" id="claimReason" name="claimReason"  value="${orderClaim.claimReason}"   class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>	
				</tr>
				...
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="remark" name="remark"   value="${orderClaim.remark}"  class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>	
						<td class="ui_text_rt">跟进人</td>
					<td class="ui_text_lt">
						<input type="text" id="followMan" name="followMan"  value="${orderClaim.followMan}"  class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>	
					
					</td>	
						<td class="ui_text_rt">跟进时间</td>
					<td class="ui_text_lt">
						<input type="text" id="followDate" name="followDate"   value="${orderClaim.followDate}"  onClick="WdatePicker()"  class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>	
                        <td class="ui_text_rt">状态</td>
					<td class="ui_text_lt">
						<input type="text" id="status" name="status"  value="${orderClaim.status}"   class="ui_input_txt02"/>
					</td>				
				</tr>
				<tr>
					<td>&nbsp;</td>
