		...
		$("#submitbutton").click(function() {
			 ...
			 for(var i = 0;i<params.length;i++){
			  ...
			  $.ajax({ 
	            ...
	            url: basePath+"/NoticeController/update.do", 
...
<input type="text" id="id" name="id" value="${notice.id}" hidden="hidden" >
	<div id="container">
		<div id="nav_links">
			当前位置：公告管理&nbsp;>&nbsp;<span style="color: #1A5CC6;">公告修改</span>
			<div id="page_close">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="comment" name="comment" value="${notice.comment}" class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
				</tr>
				<tr>
