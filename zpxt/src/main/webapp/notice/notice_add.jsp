		...
		$("#submitbutton").click(function() {
			 ...
			 for(var i = 0;i<params.length;i++){
			  ...
			  $.ajax({ 
	            ...
	            url: basePath+"/NoticeController/save.do", 
...
<form id="submitForm" name="submitForm" method="post">
	<div id="container">
		<div id="nav_links">
			当前位置：公告管理&nbsp;>&nbsp;<span style="color: #1A5CC6;">公告新增</span>
			<div id="page_close">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="comment" name="comment" class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
				</tr>
				<tr>
