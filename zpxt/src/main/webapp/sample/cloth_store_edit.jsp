		...
		$("#submitbutton").click(function() {
			 ...
			 for(var i = 0;i<params.length;i++){
			  ...
			  $.ajax({ 
	            ...
	            url: basePath+"/ClothRequireStoreController/update.do", 
...
<form id="submitForm" name="submitForm" method="post">
   <input type="text" id="clothCode" name="clothCode" value="${clothRequireStore.clothCode}" hidden="hidden"/>
	<div id="container">
		<div id="nav_links">
			当前位置：样衣管理&nbsp;>&nbsp;<span style="color: #1A5CC6;">样衣库存编辑</span>
			<div id="page_close">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="clothID" name="clothID" value="${clothRequireStore.clothID}" class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
					<td class="ui_text_rt">颜色</td>
					<td class="ui_text_lt">
						<input type="text" id="color" name="color" value="${clothRequireStore.color}" class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
				...
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="storeNum" name="storeNum" value="${clothRequireStore.storeNum}" class="ui_input_txt02"/></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td class="ui_text_lt">
