		...
		$("#submitbutton").click(function() {
			 ...
			 for(var i = 0;i<params.length;i++){
			  ...
			  $.ajax({ 
	            ...
	            url: basePath+"/ClothRequireStoreInfoController/save.do", 
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
						...
						<select name="clothCode" id="clothCode" class="ui_select01">
                            <option value="">--请选择--</option>
                             <c:forEach items="${dList}" var="ps"  varStatus="i">
                                   <option value="${ps.clothCode}">${ps.clothID}/${ps.color}</option>
                             </c:forEach>
				...
				<tr>
					...
					<td class="ui_text_lt">
						<select name="outIn" id="outIn" class="ui_select02">
				...
				<tr>
					...
					<td class="ui_text_lt">
						...
						&nbsp;<input id="cancelbutton" type="button"  onclick="javascript:history.back(-1);" value="取消" class="ui_input_btn01"/>
					</td>
				</tr>
			</table>
		</div>
