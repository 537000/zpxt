...
<form id="submitForm" name="submitForm" method="post">
	<div id="container">
		<div id="nav_links">
			当前位置：财务管理&nbsp;>&nbsp;<span style="color: #1A5CC6;">资产管理</span>
			<div id="page_close">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<td class="ui_text_rt">资产名</td>
					<td class="ui_text_lt">
						<input type="text" id="assetName" name="assetName"   class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
	            ...
	            <td class="ui_text_rt">入库日期</td>
					<td class="ui_text_lt">
						<input type="text" id="saveDate" name="saveDate" onClick="WdatePicker()"  class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
