...
/* 		 var param = $("#submitForm").serialize();
		 ...
		 for(var i = 0;i<params.length;i++){
		  ...
		  $.ajax({ 
            ...
            url: basePath+"/account/update.do", 
...
<form id="submitForm" name="submitForm" method="post">
	<div id="container">
		<div id="nav_links">
			当前位置：财务管理&nbsp;>&nbsp;<span style="color: #1A5CC6;">会计凭证编辑</span>
			<div id="page_close">
		...
		<div class="ui_content">
			...
			<input name="id" id="id" value="${ac.id}"  type="hidden"/>		
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="agent" name="agent" value="${ac.agent}"  class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
					<td class="ui_text_rt" width="80">摘要</td>
					<td class="ui_text_lt">
						<input type="text" id="abstracts" name="abstracts"  value="${ac.abstracts}"  class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
					<td class="ui_text_rt">明细</td>
					<td class="ui_text_lt">
						<input type="text" id="detail" name="detail" value="${ac.detail}"  class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
				</tr>
	            <tr>
					<td class="ui_text_rt" width="80">借方</td>
					<td class="ui_text_lt">
						<input type="text" id="debit" name="debit" value="${ac.debit}"   class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
					<td class="ui_text_rt">贷方</td>
					<td class="ui_text_lt">
						<input type="text" id="credit" name="credit"  value="${ac.credit}" class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
