...
<form id="submitForm" name="submitForm" method="post">
	<div id="container">
		<div id="nav_links">
			当前位置：财务管理&nbsp;>&nbsp;<span style="color: #1A5CC6;">调账</span>
			<div id="page_close">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<td class="ui_text_rt">项目名</td>
					<td class="ui_text_lt">
						<input type="text" id="dname" name="dname"   class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
					...
					<td class="ui_text_lt">
						<input type="text" id="dtype" name="dtype" class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
				</tr>
	            <tr>
					<td class="ui_text_rt" width="80">调账时间</td>
					<td class="ui_text_lt">
						<input type="text" id="ddate" name="ddate"   onClick="WdatePicker()"  class="ui_input_txt02"/><font style="color: red;">*</font>
					</td>
